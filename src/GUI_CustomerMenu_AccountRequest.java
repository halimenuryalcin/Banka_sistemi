 ...
 * @author Doğukan
 */
public class GUI_CustomerMenu_AccountRequest extends javax.swing.JFrame {
        musterilerManager mm = new musterilerManager();
    /**
     * Creates new form GUI_CustomerMenu_AccountRequest
     */
    public GUI_CustomerMenu_AccountRequest() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Talep Turunuzu hesapac veya hesapsil olarak giriniz. ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUI_CustomerMenu_AccountRequest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUI_CustomerMenu_AccountRequest().setVisible(true);
            }
        });
    }
